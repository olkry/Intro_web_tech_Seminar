...
$resume = [
    [
        'namless' => 'Front End Developer',
        'start' => 'Jan 2015 -',
        'finish' => 'Current',
        'info' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
              sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [
        'namless' => 'Web Developer / something.com',
        'start' => 'Mar 2012 -',
        'finish' => 'Dec 2014',
        'info' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
              sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'   
    ],
    [
        'namless' => 'Graphic Designer / designsomething.com',
        'start' => 'Jun 2010 -',
        'finish' => 'Mar 2012',
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $resume[$i]['namless']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $resume[$i]['start']?> <span
                class="w3-tag w3-teal w3-round"><?php echo $resume[$i]['finish']?></span></h6>
            <p><?php echo $resume[$i]['info']?></p>
            <hr>
          </div>
          <?php }?>
        </div>
